...
<body>
    ...
    <div class="container-fluid">
        ...
        <h3 class="text-center text-dark my-5">Incomplete Orders</h3>
        <div class="table-responsive">
            <table class="table table-hover table-bordered table-striped table-success">
                ...
                $query = "select * from incomplete order by In_id desc limit $start_from,$num_per_page";
                ...
                ?>
                    ...
                    <tr class=" text-center">
                        ...
                        <td>
                            <form action="add_expense.php" method="post" enctype="multipart/form-data" requied>

                                <div class="my-2 mx-2"> <?php echo $row['expense']; ?>
                                </div>
                                <input id="id" type="hidden" name="id" value="<?php echo $row['In_id']; ?>">
                                <input id="expense" name="expense" placeholder="Add Expense">
                                <button type="submit" value="Save" name="submit" class="btn btn-primary">Add</button>
                        ...
                        <td>
                            <a onclick="if (confirm('Order and Delivery done?')){return true;}else{event.stopPropagation(); event.preventDefault();};" class="btn btn-success" href="order_complete.php? id=<?php echo $row['In_id'] ?>">Complete</a>
                        </td>
        ...
        <?php
        $pr_query  = "select * from incomplete";
        ...
        if ($page > 1) {
            echo "<a href='incomplete.php?page=" . ($page - 1) . "' class='btn btn-danger mx-1 my-3'>Previous</a>";
        }

        for ($i = 1; $i < $total_pages; $i++) {
            echo "<a href='incomplete.php?page=" . $i . "'class='btn btn-primary mx-1 my-3'>" . $i . "</a>";
        }

        if ($i > $page) {
            echo "<a href='incomplete.php?page=" . ($page + 1) . "' class='btn btn-danger mx-1 my-3'>Next</a>";
        }
