    ...
    <div class="container-fluid">
        ...
        <div class="table-responsive">
            <table class="table table-hover table-bordered table-striped table-success">
                ...
                $query = "select * from clients order by client_id desc limit $start_from,$num_per_page";
                ...
                ?>
                    ...
                    <tr class=" text-center">
                        ...
                        <td>
                            <a onclick="if (confirm('Delete client?')){return true;}else{event.stopPropagation(); event.preventDefault();};" class="btn btn-danger" href="del_clients.php? bn=<?php echo $row['client_id'] ?>">Delete</a>
                        </td>
