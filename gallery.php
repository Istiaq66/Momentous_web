...
$query = "select * from pictures order by p_id desc limit 12";
...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavDropdown">
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="cinematography.html">CINEMATOGRAPHY</a>
                            </li>
                            <li class="nav-item">
    ...
    <main id="gallery-page">
        ...
        <section id="heading-section">
            <h2 class="text-center mb-4 text-white">Our Gallery</h2>
        </section>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="links mt-5">
                        ...
                        <p><a href="./about_us.html" id="">Photographers </a> </p>
                        <p><a href="./packages.html" id="">Packages</a> </p>
                        <p><a href="./booking_form.html" id="">Book Now</a> </p>
    ...
    <!--    image-viewer-->
    <script src="plugin/image_viewer/view-image.js"></script>
